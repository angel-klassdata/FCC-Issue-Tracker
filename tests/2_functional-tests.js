      ...
      test("Create an issue with every field: POST request to /api/issues/{project}", function (done) {
        chai
          ...
          .end(function (err, res) {
            ...
            assert.equal(res.body.assigned_to, "Paco");
        ...
        chai
          ...
          .end(function (err, res) {
            ...
            assert.deepEqual(res.body[0], {
              ...
              issue_title: "a",
              issue_text: "a",
              created_on: "2024-03-03T10:48:41.457Z",
              updated_on: "2024-03-03T10:48:41.457Z",
              created_by: "a",
              assigned_to: "",
              projectId: "65e45589b779ec50fec4c5e3",
              open: true,
              status_text: "",
            });
            done();
    ...
    suite("5 Put request Tests", function () {
      test("Update one field on an issue: PUT request to /api/issues/test-data-put", function (done) {
        chai
          ...
          .send({
            _id: "65e453646b503747e3c1e261",
            issue_title: "different",
          })
          .end(function (err, res) {
            assert.equal(res.status, 200);
            assert.equal(res.body.result, "successfully updated");
            assert.equal(res.body._id, "65e453646b503747e3c1e261");
